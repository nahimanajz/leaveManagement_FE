...
import LeaveBalanceDialog from "@/components/dialogs/UpdateLeaveBalance";
...
const ManageLeaves: React.FC = () => {
  const [selectedRequest, setSelectedRequest] = useState<LeaveResponse | null>(
    null
  );
  ...
  const updateLeaveMutation = useMutation({
    mutationFn: (data: UpdateLeaveRequest) => updateLeave(data),
    onSuccess: () => {
            ...
            <TableBody>
              {leaveRequests.map((request: LeaveResponse) => (
                <TableRow key={request.id}>
                  ...
                  <TableCell>
                    {getStatusBadge(request.approvalStatus.toLocaleLowerCase())}
                  </TableCell>
                    ...
                    <div className="flex justify-end gap-2">
                      {request.approvalStatus.toLocaleLowerCase() ===
                        ...
                        <>
                          ...
                          <LeaveBalanceDialog request={request}/>
                        </>
                      )}
